                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="section">
                        ...
                        {formData.creditCards?.map((card, index) => (
                            <div key={index} className="credit-card-display">
                                <p>
                                    Card {index + 1}: **** **** **** {card.creditCardNumber ? card.creditCardNumber.slice(-4) : '****'}
                                </p>
                                <p>Expiry Date: **/**</p> {/* Masked expiry date */}
                                <p>CVV: ***</p> {/* Masking CVV */}
                                <button type="button" className="remove-card-button" onClick={() => removeCreditCard(index)}>
                                    Remove
                                </button>
                    ...
                    <div className="promotion-checkout">
                        ...
                        <div className="checkbox-wrapper">
                            <input
                                ...
                                onChange={handleChange}
                            />
                            <label htmlFor="promotions">Subscribe to promotions</label>
                        </div>
                    </div>
